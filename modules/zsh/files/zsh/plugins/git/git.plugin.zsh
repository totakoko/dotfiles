# Original from https://github.com/sorin-ionescu/prezto/blob/1d58546406bc8f13b910141265f67dbe2f08bd5f/modules/git/alias.zsh
# Adapted to Oh My Zsh and my own usage
...
# Log (l)
alias gl='git log --graph --pretty=format:"%C(auto)%h%d - %Cgreen%cD%Creset - %Cblue%an%Creset - %s"'
alias gls='git log --topo-order --stat --pretty=format:"${_git_log_medium_format}"'
alias gld='git log --topo-order --stat --patch --full-diff --pretty=format:"${_git_log_medium_format}"'
alias glo='git log --topo-order --pretty=format:"${_git_log_oneline_format}"'
alias glg='git log --topo-order --oneline --all --graph --decorate'
...
alias gpp='git pull origin "$(git rev-parse --abbrev-ref HEAD)" && git push origin "$(git rev-parse --abbrev-ref HEAD)"'
